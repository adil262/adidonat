<?php
    ...
    if(isset($_POST['insert'])){
        ...
        if(move_uploaded_file($file, $path.$gambar)){
            $query = mysqli_query($link, "INSERT INTO produk (nama_produk, gambar_produk, harga_produk, id_kategori) 
                    VALUE ('$nama', '$gambar', '$harga', '$kategori')");
            if($query){
        ...
        <div class="container-fluid">
                ...
                <div class="card mb-3">
                    <div class="card-header">
                        <i class="fas fa-table"></i> Data Tabel Produk
                        </div>
                    <div class="card-body">
