<?php
    ...
    if(isset($_POST['update'])){
        ...
        $query = mysqli_query($link, "UPDATE kategori SET nama_kategori = '$nama' WHERE id_kategori = '$id'");
        if($query){
            echo "<meta http-equiv='refresh' content='0,url=".BASE_URL."admin/kategori.php'";
        }
    }
    $query = mysqli_query($link, "SELECT nama_kategori FROM kategori WHERE id_kategori = '$id'");
        ...
        <div class="container-fluid">
                ...
                <div class="card mb-3">
                    <div class="card-header">
                        <i class="fas fa-table"></i> Edit Tabel Kategori
                        </div>
                    <div class="card-body">
